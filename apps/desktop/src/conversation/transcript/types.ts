import type { AgentMessageContent } from '@pasture/protocol';
import type { AgentMessageItem } from '@pasture/protocol';
...
import type { ExecOutputStream } from '@pasture/protocol';
import type { FileChange } from '@pasture/protocol';
import type { McpInvocation } from '@pasture/protocol';
...
import type { ReasoningItem } from '@pasture/protocol';
import type { StepStatus } from '@pasture/protocol';
import type { TurnItem } from '@pasture/protocol';
import type { UserInput } from '@pasture/protocol';
import type { UserMessageItem } from '@pasture/protocol';
import type { WebSearchItem } from '@pasture/protocol';
